# Altiair — Hackathon README (Ben's draft)
...
1. Project name: **Altiair** (not Altiair)
...
10. Spelling: **Altiair** everywhere (overrides Discord channel name)
...
| t | Action | Said |
|---|---|---|
| 0:00 | Phones face-up, Pi visible w/ battery + router. | "Altiair. Statement 2. Attritable mission C2 for DDIL." |
